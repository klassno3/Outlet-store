  ...
  return (
    ...
    <div className='flex w-11/12 mx-auto items-start justify-between pt-20  z-10 relative'>
      <div className='w-full md:w-1/2 pt-8' >
        <h1 className='text-5xl md:flex justify-center mx-auto  md:text-left md:mx-0 text-center pt-5 leading-[3.2rem] xl:leading-[4.5rem] font-bold font-play  bg-gradient-to-r from-primary-300 via-primary-200 to-primary-100 text-transparent bg-clip-text md:text-5xl xl:text-6xl'>
      ...
      <div className="hidden md:block w-1/3 xl:w-full">
      ...
      <div className='relative z-10 w-11/12 mx-auto flex flex-col lg:flex-row justify-between  gap-8  xl:gap-10 my-20'>
        <div className='shadow-xl bg-white  lg:w-1/3 w-4/5 md:w-1/2 mx-auto rounded-md px-6 py-3 flex gap-10 transition-all duration-300  hover:scale-105 hover:shadow-2xl'>
          ...
          <div className="flex justify-between gap-10 items-center ">
            ...
            <div className="flex flex-col lg:text-sm xl:text-xl">
        ...
        <div className='shadow-2xl bg-white lg:w-1/3 w-4/5  md:w-1/2 mx-auto rounded-md px-6 py-3 flex gap-10 transition-all duration-300  hover:scale-105 hover:shadow-2xl'>
          ...
          <div className="flex justify-between gap-10 items-center">
            ...
            <div className="flex flex-col lg:text-sm xl:text-lg">
